...
var AmortizationChart = createReactClass({ //= React.createClass({
    render: function () {
...
var MortgageCalculator = createReactClass({ //= React.createClass({
...
var App = createReactClass({ //= React.createClass({
    render: function () {
        return (
            <div>
